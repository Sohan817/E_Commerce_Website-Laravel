                                ...
                                @foreach ($product->product_images as $key => $productImage)
                                    <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                                        <img class="w-100 h-100"
                                            src="{{ asset('uploads/products/largeImage/' . $productImage->image) }}"
                                            alt="Image">
                                    </div>
                                @endforeach
                            @endif
                    ...
                    <div class="bg-light right">
                        ...
                        <div class="d-flex mb-3">
                            ...
                            <small class="pt-2 ps-1">(
                                {{ $product->product_rating_count > 1 ? $product->product_rating_count . ' Reviews' : $product->product_rating_count . ' Review' }})</small>
                        </div>

                        @if ($product->compare_price > 0)
                            <span <h2 class="price text-secondary"><del>${{ $product->compare_price }}</del></h2>
                        @endif
                    ...
                    <div class="bg-light">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
                                <div class="col-md-8">
                                    <div class="row">
                                        <form action="" name="productRatinForm" id="productRatinForm"
                                            method= "post">
                                ...
                                <div class="col-md-12 mt-5">
                                    <div class="overall-rating mb-3">
                                        <div class="d-flex">
                                            ...
                                            <div class="pt-2 ps-2">(
                                                {{ $product->product_rating_count > 1 ? $product->product_rating_count . ' Reviews' : $product->product_rating_count . ' Review' }}
                                                )
                                            </div>
                                        </div>
...
@section('customJs')
    <script>
        $("#productRatinForm").submit(function(event) {
            event.preventDefault();
            $.ajax({
                url: "{{ route('front.storeProductRating', $product->id) }}",
                type: "post",
                ...
                success: function(response) {
                    if (response.status == true) {
                        ...
                        if (errors.username) {
                            $("#username").addClass('is-invalid').siblings('p').html(errors.username)
                                .addClass('invalid-feedback');
                        } else {
                            $("#username").removeClass('is-invalid').siblings('p').html('')
                        ...
                        if (errors.comment) {
                            $("#comment").addClass('is-invalid').siblings('p').html(errors.comment)
                                .addClass('invalid-feedback');
                        } else {
